...
/* package kudosu-0.1.0.0 */
#ifndef VERSION_kudosu
#define VERSION_kudosu "0.1.0.0"
#endif /* VERSION_kudosu */
#ifndef MIN_VERSION_kudosu
#define MIN_VERSION_kudosu(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_kudosu */
...
#define CURRENT_COMPONENT_ID "kudosu-0.1.0.0-inplace-kudosu"
